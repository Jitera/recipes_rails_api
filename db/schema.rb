...
ActiveRecord::Schema[7.0].define(version: 2022_12_18_160036) do
  ...
  create_table "recipe_rates", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recipe_id"], name: "index_recipe_rates_on_recipe_id"
    t.index ["user_id", "recipe_id"], name: "index_recipe_rates_on_user_id_and_recipe_id", unique: true
  ...
  add_foreign_key "recipe_rates", "recipes"
